 ...
 */
export function createLspConnection(index: FeatureIndex) {
  ...
  connection.onInitialize((params) => {
    ...
    const result: InitializeResult = {
      capabilities: {
        ...
        // Feature-ownership badge at line 0 of every file
        codeLensProvider: {
  ...
  // -----------------------------------------------------------------
  // initialized — wire up diagnostic push
  // -----------------------------------------------------------------
  connection.onInitialized(() => {
    setupDiagnostics(connection, index)
    connection.console.log('lac-lsp: ready')
  })
  ...
  // -----------------------------------------------------------------
  // Workspace folder changes — re-index on folder add
  // -----------------------------------------------------------------
