...
export const ALL_HUB_ENTRIES: HubEntry[] = [
  ...
  { file: "lac-roles.html",        label: "Roles View",         description: "All stakeholder views in one place — User / Product / Dev / QA / Support / Architect + Compare mode", icon: "🎭", primary: true  },
